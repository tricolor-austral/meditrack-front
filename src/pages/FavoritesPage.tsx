...
const medics = [
  { name: 'Liza Trays', email: 'lizatrass@mail.com', specialty: 'Cardiologist', imgSrc: d2 },
  ...
  { name: 'Emily Stone', email: 'e.stone@mail.com', specialty: 'Ophthalmologist', imgSrc: d6 },
  { name: 'George Smith', email: 'g.smith@mail.com', specialty: 'ENT Specialist', imgSrc: d7 },
...
const FavoritesPage: React.FC = () => {
  ...
  return (
    <div className="space-y-4 mt-4">
        <div className={'max-h-[640px] overflow-scroll flex-col gap-4 flex mb-[80px]'}>
